...
if not os.path.exists("C:\Sign-Language-to-Text-Conversion-main\Source Code\data"):
    os.makedirs("C:\Sign-Language-to-Text-Conversion-main\Source Code\data")
if not os.path.exists("C:\Sign-Language-to-Text-Conversion-main\Source Code\data/train"):
    os.makedirs("C:\Sign-Language-to-Text-Conversion-main\Source Code\data/train")
if not os.path.exists("C:\Sign-Language-to-Text-Conversion-main\Source Code\data/test"):
    os.makedirs("C:\Sign-Language-to-Text-Conversion-main\Source Code\data/test")
for i in range(10):
    if not os.path.exists("C:\Sign-Language-to-Text-Conversion-main\Source Code\data/train/" + str(i)):
        os.makedirs("C:\Sign-Language-to-Text-Conversion-main\Source Code\data/train/"+str(i))
    if not os.path.exists("C:\Sign-Language-to-Text-Conversion-main\Source Code\data/test/" + str(i)):
        os.makedirs("C:\Sign-Language-to-Text-Conversion-main\Source Code\data/test/"+str(i))

for i in string.ascii_uppercase:
    if not os.path.exists("C:\Sign-Language-to-Text-Conversion-main\Source Code\data/train/" + i):
        os.makedirs("C:\Sign-Language-to-Text-Conversion-main\Source Code\data/train/"+i)
    if not os.path.exists("C:\Sign-Language-to-Text-Conversion-main\Source Code\data/test/" + i):
        os.makedirs("C:\Sign-Language-to-Text-Conversion-main\Source Code\data/test/"+i)
    


# Train or test 
mode = 'train'
directory = 'C:\Sign-Language-to-Text-Conversion-main\Source Code\data/'+mode+'/'
minValue = 70
